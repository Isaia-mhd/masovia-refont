<div class="w-[100%] text-white bg-[#585980] rounded-md py-6 cursor-pointer space-y-10 px-6 hover:bg-[#F0F235] hover:text-black group transition duration-175">
    ...
    <div class="w-full text-center bg-[#585980] border-1 border-gray-300 rounded-md py-3 group-hover:!bg-black group-hover:text-white group-hover:border-none">
