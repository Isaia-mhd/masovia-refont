...
return [
    ...
    | comme les règles de taille. N'hésitez pas à modifier chaque message ici.
    |
    */
    ...
    'ascii' => 'Le champ :attribute ne peut contenir que des caractères alphanumériques et symboles en un octet.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Ces lignes de langue servent à remplacer le placeholder de l'attribut
    | par quelque chose de plus lisible, comme "Adresse E-Mail" à la place
    | de "email". Cela rend le message plus compréhensible.
    |
    */
